...
<html lang="fr-CA">
  <head>
    ...
    <script type="module">
      ...
      import {binded, binders, binding, action, gstates, sstates, obsstates, robsstates} from '../js/index.mjs';
      ...
      setTimeout(() => {
        window.appz = {binded, binders, binding, action, gstates, sstates, obsstates, robsstates}
      })
    </script>
  ...
  <body id="body" class="body">
    ...
    <script type="application/json" data-value="test.samples.whatever" data-binders="#">
      {
        "object" : {
          "array": [
            1,2,3
          ],
          "string": "this is à test string",
          "number": 666,
          "bool": true,
          "code": "type in console: window.appz.gstates('test').then((r)=>console.log(r));"
        }  
      }
    </script>
    ...
    <div class="container">
      <div class="response">
        <span>Test Data: </span>
        <!-- will foce only that one for debug purpose -->
        <div data-binded="test"></div>
        <button data-action="delete" data-prop="test" class="clear">clear state</button>  
      </div>  
    </div> 
